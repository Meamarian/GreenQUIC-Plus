...
def main()->int:
    ...
    measures=['aggregate_goodput_gbps','average_individual_goodput_gbps','combined_total_j','combined_avg_rapl_w','combined_j_per_useful_gbit','server_dataplane_mean_ghz','client_dataplane_mean_ghz'];summary={'mode':'linux','n':len(rows),'connections':a.connections}
    for m in measures:
