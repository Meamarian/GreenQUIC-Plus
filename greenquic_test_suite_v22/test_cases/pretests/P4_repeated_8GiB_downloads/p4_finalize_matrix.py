...
def main() -> int:
    ...
    try:
        ...
        print(f"[P4:WARN] named C-state chart was not generated: {exc}")
    ...
    integrity = {
        "schema": "greenquic-p4-unified-matrix-v1",
        "matrix": str(matrix),
    ...
    print("[P4] Unified matrix integrity: PASS")
    print(f"[P4] Named CPUIdle chart: {charts / 'linux_cstate_residency_by_mode.svg'}")
    return 0
