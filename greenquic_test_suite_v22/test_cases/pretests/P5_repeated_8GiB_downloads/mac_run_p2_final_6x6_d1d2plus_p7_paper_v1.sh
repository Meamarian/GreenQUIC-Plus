...
("P5_MARKER='GREENQUIC-P5-PERFORMANCE2-V2 txalloc=8 txenqcounter=0 txmetazero=1 rxpipe=2 shardmask=0'","P5_MARKER='GREENQUIC-P5-D1D2PLUS-SNAPSHOT-V2'",'P5 marker'),
...
('P5_default=txalloc8+no_TxEnqueueCounter+RXpipe2+safe_TX_zero','P5_default=txalloc8+no_TxEnqueueCounter+RXpipe2+safe_TX_zero+D1D2plus_boundary_snapshots_v2','source desc'),
('P7_config=native_offloads+IRQ_CPU19+QUIC_21_22_23_24+pinning+RPS_off','P7_config=paper_offloads+disable_RDMA+rmem_6815744+wmem_6815744+combined_channels_1+IRQ_CPU19+QUIC_21_22_23_24+pinning+RPS_off+D1D2plus_report_v2','P7 desc'),
