...
RESULT_ROOT="${RESULT_ROOT:-/tmp/P5_COMBO_ISOLATED_${STAMP}}"
MATRIX_ROOT="$HERE/matrix_results/P5_COMBO_ISOLATED_${STAMP}"
...
BUILD_HELPER="$HERE/build_p5_cache128_pool8191_feature.sh"
mkdir -p "$RESULT_ROOT/logs" "$MATRIX_ROOT"

cat > "$CONFIGS" <<'EOF'
index	profile	feature	cache	rxpool	txpool	rxd	txd	rxb	txb	ring
00	combo_control	control	128	8191	8191	4096	4096	32	32	4096
01	combo_txretry1	txretry1	128	8191	8191	4096	4096	32	32	4096
02	combo_udpcksum	udpcksum	128	8191	8191	4096	4096	32	32	4096
03	combo_lockfree	lockfree	128	8191	8191	4096	4096	32	32	4096
04	combo_counters	counters	128	8191	8191	4096	4096	32	32	4096
05	combo_rxalloc4	rxalloc4	128	8191	8191	4096	4096	32	32	4096
EOF
...
run_one() {
    ...
    echo "BASE: cache128 + pool8191"
    echo "ONLY FEATURE: $feature"
    echo "======================================================================"
...
echo "======================================================================"
echo "P5 CACHE128 + POOL8191 ISOLATED FEATURE SWEEP"
echo "Each feature is built and tested separately; features are NEVER combined."
...
echo
echo "PREVIOUS SINGLE-PARAMETER REFERENCES"
echo "cache128 : OFF=8.956036 BASIC=8.813568 PLUS=9.743661 Gbit/s"
echo "pool8191 : OFF=9.341364 BASIC=8.443487 PLUS=9.589398 Gbit/s"
...
echo "Deltas are versus the new cache128+pool8191 control."
echo "======================================================================"
