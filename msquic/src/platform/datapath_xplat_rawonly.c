...
{
    UNREFERENCED_PARAMETER(UdpCallbacks);
...
{
    return RawDataPathGetSupportedFeatures(Datapath->RawDataPath);
}
    ...
    )
{
    ...
    return
        DatapathType(SendData) == RawDataPathIsPaddingPreferred(Datapath);
}
